...
public class RegistrationInfo {
  ...
  public Date getSee_doctor_date() {
    return see_doctor_date;
  }

  public void setSee_doctor_date(Date see_doctor_date) {
  ...
  public void setIs_seen_doctor(String is_seen_doctor) {
    this.is_seen_doctor = is_seen_doctor;
  }
