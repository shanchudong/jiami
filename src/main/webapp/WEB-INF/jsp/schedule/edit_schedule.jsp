...
<script type="text/javascript" language="JavaScript">
	...
	function getParent() {
        var param = $(window.parent.getDoctorId());
        var jsonData = JSON.stringify(param);
        var num = jsonData[5];
        var opt = document.getElementById("doctorId");
        opt.setAttribute("value", num);
        document.getElementById("doctorId").value = num;
        getDoctorName(num);
        getDepartmentName(num);
    }
</script>
				...
				<form id="add" method="post" action="#" style="padding: 20px;" role="form">
					<div class="layui-row">
						...
						<div class="layui-col-xs6 layui-col-sm6 layui-col-md11">
							<input class="layui-input" id="doctorId" autocomplete="off" readonly="true" value="">
						</div>
						<br>
						...
						<div class="layui-col-xs6 layui-col-sm6 layui-col-md11">
							<input class="layui-input" id="limitNum" autocomplete="off" >
						</div>
						<br>
